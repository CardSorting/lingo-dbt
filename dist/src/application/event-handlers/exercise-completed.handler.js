 ...
 */
export class ExerciseCompletedEventHandler {
    constructor(progressReadRepository, progressWriteRepository) {
     ...
     */
    async checkAndAwardAchievements(userId, moduleId, skillId, lessonId) {
        ...
        if (lessonProgress === null || lessonProgress === void 0 ? void 0 : lessonProgress.isCompleted) {
